...
const MODULES = [
  {
    ...
    labelAr: 'الأساسات',
    labelEn: 'Foundations',
    descAr: 'تصميم الأساسات المنفردة والمستمرة والمشتركة والحصيرة العامة وفق الكود العربي السوري - ملحق 5',
    descEn: 'Design of isolated, continuous, combined and mat foundations per Syrian Arabic Code - Annex 5',
    active: true,
    badge: 'ملحق 5',
  },
  {
